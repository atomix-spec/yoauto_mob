...
class _MyListingsScreenState extends State<MyListingsScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback(
      (_) => context.read<ListingsProvider>().loadMyListings(),
    );
  }
    ...
    return Scaffold(
      ...
      body: Consumer<ListingsProvider>(
        builder: (context, listingsProvider, _) {
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    FilledButton.icon(
                      onPressed: () => listingsProvider.loadMyListings(),
          ...
          final listings = listingsProvider.myListings;
          ...
          return RefreshIndicator(
            onRefresh: () => listingsProvider.loadMyListings(),
            child: ListView.builder(
              padding: const EdgeInsets.symmetric(vertical: 8.0),
              itemCount: listings.length,
              itemBuilder: (context, index) {
                final ListingCardResponse card = listings[index];
                return _ListingCard(
                  card: card,
